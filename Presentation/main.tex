...
\begin{frame}{Experiments}
    \begin{columns}
        \begin{column}{0.6\textwidth}
            \begin{itemize}
            \justifying
            \item The \textit{ekf\_localization\_node} was tested in a MobileRobots Pioneer eqquiped with wheel encoders, two IMUs and two GPSes.
...
\begin{frame}{Experiments}
    ...
    \begin{column}{0.5\textwidth}
        \begin{figure}
            ...
            \caption*{Output of \textit{ekf\_localization\_node} (blue) when fusing data from odometry, two IMUs and two GPS units.}
        \end{figure} 
    \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Conclusion and Future Work}
    ...
    \begin{itemize}
        ...
        \item Covariance Override \xmark
    \end{itemize}
\end{frame}
